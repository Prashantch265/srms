...
const deleteStudentDetails = async (id) => {
    return await Student.update({ isActive: false, isDeleted: true }, { where: { id: id } });
}

module.exports = { addStudentDetails, updateStudentDetails, findAll, findById, deleteStudentDetails };